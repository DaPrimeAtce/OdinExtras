...
object ClickGUIPlus : Module(
    ...
    val alphabeticalSorting by BooleanSetting("Alphabetical Sorting", false, desc = "Sorts the module lists alphabetically instead of Odin's default widest-first order.")
